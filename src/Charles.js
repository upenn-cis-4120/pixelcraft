...
import charlesicon from './icons/charles.webp';
    ...
    return (
        <div className="home-screen">
                ...
                <button onClick={() => navigate(-1)} className="back-arrow-icon-button">
                    ...
                    <div className="profile-text">Charles Schwab</div>
                </div>

            {/* Equity Rectangle */}
{/* Equity Rectangle */}
<div className="equity-rectangle">
    <img src={charlesicon} alt="Robinhood Icon" className="broker-icon-new" />
    <p className='broker-text'>Charles Schwab</p>
    <p className='broker-number'>$236,000</p>
</div>
