...
import robinhoodicon from './icons/robinhood.png';
    ...
    return (
        <div className="home-screen">
                ...
                <button onClick={() => navigate(-1)} className="back-arrow-icon-button">
                    ...
                    <div className="profile-text">Robinhood</div>
                </div>

            {/* Equity Rectangle */}
{/* Equity Rectangle */}
<div className="equity-rectangle">
    <img src={robinhoodicon} alt="Robinhood Icon" className="broker-icon-new" />
    <p className='broker-text'>Robinhood</p>
    <p className='broker-number'>$750,000</p>
</div>
